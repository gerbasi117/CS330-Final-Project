...
public:
	...
	void RenderLighthouseBase();
	void RenderLighthouseLight();
	void RenderLighthouseBeam();
	void RenderGround();
	void RenderLighthouseTop();
	void RenderLighthouseLight2();
	void RenderLighthouseLight2Base();
};